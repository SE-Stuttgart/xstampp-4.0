...
var grammar = {
    ...
    {"name": "konstante$subexpression$1$ebnf$1", "symbols": ["konstante$subexpression$1$ebnf$1$subexpression$1"]},
    {"name": "konstante$subexpression$1$ebnf$1$subexpression$2", "symbols": [/[0-9]/]},
    {"name": "konstante$subexpression$1$ebnf$1", "symbols": ["konstante$subexpression$1$ebnf$1", "konstante$subexpression$1$ebnf$1$subexpression$2"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    ...
    {"name": "konstante$subexpression$2", "symbols": [/[0-9]/]},
    {"name": "konstante", "symbols": ["konstante$subexpression$2"]},
    {"name": "konstante$subexpression$3$subexpression$1$subexpression$1", "symbols": [/[1-9]/]},
    {"name": "konstante$subexpression$3$subexpression$1$ebnf$1$subexpression$1", "symbols": [/[0-9]/]},
    {"name": "konstante$subexpression$3$subexpression$1$ebnf$1", "symbols": ["konstante$subexpression$3$subexpression$1$ebnf$1$subexpression$1"]},
    {"name": "konstante$subexpression$3$subexpression$1$ebnf$1$subexpression$2", "symbols": [/[0-9]/]},
    {"name": "konstante$subexpression$3$subexpression$1$ebnf$1", "symbols": ["konstante$subexpression$3$subexpression$1$ebnf$1", "konstante$subexpression$3$subexpression$1$ebnf$1$subexpression$2"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "konstante$subexpression$3$subexpression$1", "symbols": ["konstante$subexpression$3$subexpression$1$subexpression$1", "konstante$subexpression$3$subexpression$1$ebnf$1"]},
    {"name": "konstante$subexpression$3$ebnf$1$subexpression$1", "symbols": [/[0-9]/]},
    {"name": "konstante$subexpression$3$ebnf$1", "symbols": ["konstante$subexpression$3$ebnf$1$subexpression$1"]},
    {"name": "konstante$subexpression$3$ebnf$1$subexpression$2", "symbols": [/[0-9]/]},
    {"name": "konstante$subexpression$3$ebnf$1", "symbols": ["konstante$subexpression$3$ebnf$1", "konstante$subexpression$3$ebnf$1$subexpression$2"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "konstante$subexpression$3", "symbols": ["konstante$subexpression$3$subexpression$1", {"literal":"."}, "konstante$subexpression$3$ebnf$1"]},
    {"name": "konstante", "symbols": ["konstante$subexpression$3"]},
    {"name": "konstante$subexpression$4$ebnf$1$subexpression$1", "symbols": [/[0-9]/]},
    {"name": "konstante$subexpression$4$ebnf$1", "symbols": ["konstante$subexpression$4$ebnf$1$subexpression$1"]},
    {"name": "konstante$subexpression$4$ebnf$1$subexpression$2", "symbols": [/[0-9]/]},
    {"name": "konstante$subexpression$4$ebnf$1", "symbols": ["konstante$subexpression$4$ebnf$1", "konstante$subexpression$4$ebnf$1$subexpression$2"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "konstante$subexpression$4", "symbols": [/[0-9]/, {"literal":"."}, "konstante$subexpression$4$ebnf$1"]},
    {"name": "konstante", "symbols": ["konstante$subexpression$4"]},
